                ...
                <div class="card-body">
                    ...
                    <form action="{{ route("category.update",$category->id) }}" method="post" class="mb-3">
                        ...
                        <div class="form-inline">
                            <input type="text" name="title" placeholder="New Category" value="{{ old('title',$category->title) }}" class="form-control-lg form-control mr-2 @error('title') is-invalid @enderror" required>
